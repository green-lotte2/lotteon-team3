...
window.onload = function () {
    ...
    document.changeForm.pass2.addEventListener('focusout', () => {

        const inputPass1 = document.changeForm.pass;
        const inputPass2 = document.changeForm.pass2;
    ...
    document.changeForm.nick.addEventListener('focusout', () => {

        const type = document.changeForm.nick.dataset.type;
        const input = document.changeForm[type];
    ...
    document.changeForm.hp.addEventListener('focusout', () => {
        const type = document.changeForm.hp.dataset.type;
        const input = document.changeForm[type];
